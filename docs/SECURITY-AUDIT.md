...
| S4 | **Low** | **Answer keys and future Free Trade candles ship to the browser.** Anyone can read the answers in developer tools. See Task 2 (answer key protection). | `src/data/exercises.ts` imported by the client practice page | See [ANSWER-KEYS.md](ANSWER-KEYS.md) |
